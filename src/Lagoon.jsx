<>
  <meta charSet="utf-8" />
  <title>
    ProductLaunch | Your Ultimate Destination for All Workplace Needs
  </title>
  <meta
    content="Run all your work on one platform with customizable products that scale with your needs."
    name="description"
  />
  <meta
    content="ProductLaunch | Your Ultimate Destination for All Workplace Needs"
    property="og:title"
  />
  <meta
    content="Run all your work on one platform with customizable products that scale with your needs."
  ...
  />
  <meta
    content="https://cdn.prod.website-files.com/663a4ddb8104cb2351eeadcc/663a4eaeb31fc8dadd16305a_Opengraph.webp"
    property="og:image"
  />
  <meta
    content="ProductLaunch | Your Ultimate Destination for All Workplace Needs"
  ...
  <link
    href="https://cdn.prod.website-files.com/67210a53875af0dcf281d52a/css/lagoon-91d649.webflow.ed809b8b3.css"
    rel="stylesheet"
    type="text/css"
  />
  ...
  />
  <link
    href="https://cdn.prod.website-files.com/67210a53875af0dcf281d52a/67210a53875af0dcf281d60d_Favicon.ico"
    rel="shortcut icon"
    type="image/x-icon"
  />
  <link
    href="https://cdn.prod.website-files.com/67210a53875af0dcf281d52a/67210a53875af0dcf281d60e_Favicon%20(1).ico"
    ...
    >
      <div className="padding-global">
        <div className="nav_container">
          ...
          <div className="nav_cta-wrapper hide-tablet hide-mobile-landscape hide-mobile-portrait">
            <a
              href="https://webflow.com/website/relume-library-styleguide"
              target="_blank"
    ...
    <main className="main-wrapper">
      <header className="section_hero">
        <div className="hero_background">
          <div className="padding-global">
            ...
            <div
              id="w-node-_161d3373-905b-15b2-3336-4b8509622920-f281d5be"
              className="container-large"
            >
              <div
                id="w-node-_5c6fac5e-6002-3fbe-f5b3-89c33eb2c50f-f281d5be"
                className="hero_content align-center text-align-center"
              >
                <div className="margin-bottom margin-small">
                  <div className="heading_pill">
                    <div className="text-size-small text-weight-semibold text-color-secondary">
                ...
                <div className="max-width-medium">
                  <p className="text-size-medium">
                    With Lagoon collect, score and filter out candidates without
                    touching their resumes - simplifying screening to seconds.
                  </p>
                </div>
                  ...
                  <div className="wbs-cta-content">
                    <div className="wbs-subscribe w-form">
                      <form
                        ...
                        method="get"
                        className="wbs-subscribe-input-group"
                        data-wf-page-id="67210a53875af0dcf281d5be"
                        data-wf-element-id="41f92461-1b95-cc0d-32cc-707d8364fe1f"
                        aria-label="Subscribe form"
                      >
                        <input
                          className="wbs-form-subscribe-input w-input"
                          maxLength={256}
                        ...
                        <input
                          ...
                          className="wbs-button-subscribe w-button"
                          defaultValue="Get started"
                        />
                      </form>
                      <div
                        className="wbs-success-message w-form-done"
                        tabIndex={-1}
                        role="region"
                      ...
                      <div
                        className="wbs-error-message w-form-fail"
                        tabIndex={-1}
                        role="region"
              ...
              <div className="hero_image-wrapper align-center">
                <img
                  src="https://cdn.prod.website-files.com/67210a53875af0dcf281d52a/67210cce63f6018640cb32ef_Desktop%20-%202%20(1).png"
                  loading="lazy"
                  data-w-id="ab2a126a-6bad-ccb2-162a-5e6c18d1bb11"
                  sizes="(max-width: 479px) 100vw, (max-width: 767px) 85vw, 86vw"
                  alt=""
            ...
            <div className="padding-section-large">
              <div className="margin-bottom margin-xxlarge">
                <div className="text-align-center">
                  <div className="max-width-large align-center">
                    ...
                    <h2
                      className="heading-style-h2 text-effect-gradient"
                      style={{ opacity: 0 }}
                    >
                      Simplifying your hours of
                      <br />
                      screening to seconds.
                    </h2>
                  </div>
                </div>
              </div>
              <div className="dashboard_component">
                <div className="dashboard_list-wrapper">
                  <div
                    data-w-id="a1d95eff-8789-7862-f088-5c6c5739ef75"
                    style={{
                      transform:
                        "translate3d(0px, -1px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
                      opacity: 0,
                  ...
                  >
                        ...
                        <div className="dashboard_title-wrapper">
                          <div className="dashboard_item-content-top">
                            ...
                            <div className="padding-medium padding-bottom">
                              <div className="text-size-regular-2">
                                Tools for users to manage their account
                                settings, profile information, and preferences
                                easily.
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="dashboard_item">
                      <div className="dashboard_item-link shadow-xsmall">
                        <div className="dashboard_title-wrapper">
                          <div className="div-block">
                            <div className="dashboard_item-content-top">
                              ...
                              <div className="padding-medium padding-bottom">
                                <div className="text-size-regular-2">
                                  A central hub where users can view and
                                  interact with key information, data, and
                                  functionalities relevant to their account.
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div
                          id="w-node-a1d95eff-8789-7862-f088-5c6c5739ef8d-f281d5be"
                          className="dashboard_image-wrapper"
                        >
                          <img
                            sizes="(max-width: 479px) 100vw, (max-width: 767px) 85vw, (max-width: 991px) 39vw, 49vw"
                            srcSet="https://cdn.prod.website-files.com/67210a53875af0dcf281d52a/6724779367f044d12d341991_BR%202-p-500.png 500w, https://cdn.prod.website-files.com/67210a53875af0dcf281d52a/6724779367f044d12d341991_BR%202-p-800.png 800w, https://cdn.prod.website-files.com/67210a53875af0dcf281d52a/6724779367f044d12d341991_BR%202-p-1080.png 1080w, https://cdn.prod.website-files.com/67210a53875af0dcf281d52a/6724779367f044d12d341991_BR%202-p-1600.png 1600w, https://cdn.prod.website-files.com/67210a53875af0dcf281d52a/6724779367f044d12d341991_BR%202.png 1868w"
                            alt=""
                  ...
                  <div
                    data-w-id="a1d95eff-8789-7862-f088-5c6c5739ef8f"
                    style={{
                      transform:
                        "translate3d(0px, -1px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
                      opacity: 0,
                        ...
                        <div className="dashboard_title-wrapper">
                          <div className="dashboard_item-content-top">
                            <div className="padding-xsmall padding-vertical">
                              <h3 className="heading-style-h4-2">
                                AI Detection
                              </h3>
                            </div>
                            <div className="text-size-regular-2">
                              Generation of insightful reports and analytics to
                        ...
                        <div className="dashboard_title-wrapper">
                          <div className="dashboard_item-content-top">
                            ...
                            <div className="text-size-regular-2">
                              ...
                              to ensure usability across various devices and
                              screen sizes.
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="dashboard_item-link shadow-xsmall">
                        ...
                        <div className="dashboard_title-wrapper">
                          <div className="dashboard_item-content-top">
                            ...
                            <div className="text-size-regular-2">
                              Infrastructure and architecture designed to
                              accommodate growing user demands and scale
                              resources accordingly performance or reliability.
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="margin-top margin-xlarge">
                  <div
                    data-w-id="a1d95eff-8789-7862-f088-5c6c5739efb2"
                    style={{
                      transform:
                        "translate3d(0px, -1px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
                      opacity: 0,
      ...
      <header className="section_how-it-works">
        <div className="padding-global padding-section-large">
          <div
            id="w-node-_62cd2991-5830-f624-0ee0-c697d9dc77f0-f281d5be"
            className="container-large"
          >
            <div
              id="w-node-_62cd2991-5830-f624-0ee0-c697d9dc77f1-f281d5be"
              className="how-it-works_content align-center text-align-center"
            >
              <div className="margin-bottom margin-small">
                <div className="heading_pill">
                  <div className="text-size-small text-weight-semibold text-color-secondary">
              ...
              <div className="margin-bottom margin-small">
                <h2
                  ...
                  style={{ opacity: 0 }}
                >
                  Shortlist your best candidates in
                  <br />3 simple steps.
                </h2>
              </div>
              <p className="text-size-medium">
                Discover how ProductLaunch simplifies project management from
                start to finish. Learn about setting up projects, tracking
                progress, and achieving successful outcomes with ease
              </p>
            </div>
            <div className="spacer-large" />
            <div className="how-it-works_grid">
              <div className="how-it-works_card">
                ...
                <h4 className="heading-style-h4 text-color-secondary">
                  Enter Form URL
                </h4>
                <div className="spacer-small" />
                <p className="text-size-medium">
                  Start by sharing your Google Form URL with all the
                  applications
                </p>
              </div>
              <div className="how-it-works_card">
                ...
                <div className="spacer-small" />
                <p className="text-size-medium">
                  Add a job description to personalize the scoring algorithm
                </p>
              </div>
              <div className="how-it-works_card">
                <img
                ...
                <div className="spacer-small" />
                <p className="text-size-medium">
                  Filter the scored candidates based on your needs and shortlist
                  the best talent
                </p>
              </div>
            </div>
